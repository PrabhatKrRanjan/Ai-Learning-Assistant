...
const generateFlashcards = async (documentId, options = {}) => {
    try {
        ...
        throw error.response?.data || { message: "Failed to generate flashcards. Please try again." };
    }
};
...
const generateSummary = async (documentId) => {
    try {
        ...
        throw error.response?.data || { message: "Failed to generate summary. Please try again." };
    }
};
...
const explainConcept = async (documentId, concept) => {
    try {
        ...
        throw error.response?.data || { message: "Failed to explain concept. Please try again." };
    }
};
