...
const getDocuments = async () => {
    try {
        ...
        throw error.response?.data || { message: "Failed to fetch documents. Please try again." };
    }
};
...
const uploadDocument = async (formData) => {
    try {
        ...
        throw error.response?.data || { message: "Failed to upload document. Please check file size and format." };
    }
};
...
const deleteDocument = async (id) => {
    try {
        ...
        throw error.response?.data || { message: "Failed to delete document. Please try again." };
    }
};
